--[CREATED BY EVAN JANGAN DI UBAH UBAH KLO GAK NGERTI :V]
...
Config.Marker = {
	...
	r = 250, g = 0, b = 0, a = 100,  -- Warna Merah/ Bisa Diganti

	x = 1.0, y = 1.0, z = 1.5,       -- lingkaran kecil berbentuk silinder

	DrawDistance = 15.0, Type = 1    -- default Type Lingkaran, jarak imbang rendah karena area dalam ruangan

}



Config.MinimalPolisi = 0

Config.SebelumRobBaru    = 2400 -- Timer cooldown di toko setelah perampokan selesai / dibatalkan, dalam hitungan detik



Config.MaxJarakRampok    = 2   -- jarak maksimal dari perampokan, semakin jauh darinya akan membatalkan perampokan

Config.KasihUangKotor = true -- memberi Kan Uang Kotor? Jika dinonaktifkan itu akan memberikan uang tunai sebagai gantinya



Config.CooldownCheckOnAllShops = 1 -- Jika AKTIF (1) Tidak dapat merampok toko sebelum waktu cooldown jika perampokan terjadi di toko lain
...
Stores = {
	...
	["fleeca2"] = {
		...
		reward = math.random(550000, 750000),
	...
	["PrincipalBank"] = {
		...
		reward = math.random(1000000, 1250000),

		nameOfStore = "BANK SWEETVIBES",
	...
	["RusunBank"] = {
		...
		reward = math.random(550000, 1000000),
